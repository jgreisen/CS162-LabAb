 ...
 * Input: None
 * Output: Average of hard coded array values.
 * *************************************************************************************/
...
int main()
{
  ...
  std::cout << "The Average: " << avg_object.avg(array1, size) << std::endl;
  ...
  std::cout << std::fixed << "The Average: " << avg_object.avg(array2, size) << std::endl;
  ...
  std::cout << std::fixed << "The Average: " << avg_object.avg(array3, size) << std::endl;
